...
const configData: Config = {
  name: "Tabsy Boutique",
  tagline: "Timeless fashion for the modern era.",
  ...
  seo: {
    title: "Tabsy Boutique | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Boutique for premium halal meats and groceries. Timeless fashion for the modern era. Order online for pickup or delivery today.",
    keywords: "halal meat, halal grocery, online ordering, food delivery, pickup, fresh market, halal butcher, naperville, shahirizada"
  },
  announcement: "✨ Summer Collection is here. Free shipping on orders over $150.",
  newsletter: true,
  loyalty: {
    enabled: true,
    earnPerDollar: 10,
